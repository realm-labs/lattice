...
use super::{
    ActorGroupStore, BTreeMap, CoordinatorInspection, CoordinatorLeaseStore, CoordinatorOperation,
    CoordinatorRuntimeError, ForceRemoveRequest, GroupCoordinator, Instant,
    ManualRelocationRequest, MembershipStore, MoveProgress, NodeKey, PlacementSlotKey,
    ...
    S: CoordinatorLeaseStore + ScopedElectionStore + MembershipStore + ActorGroupStore,
{
    ...
    pub(super) async fn inspect(&self) -> Result<CoordinatorInspection, CoordinatorRuntimeError> {
        ...
        Ok(CoordinatorInspection {
            ...
            slots: self.store.list_slots(&self.version.group).await?,
            plans: self.store.list_plans(&self.version.group).await?,
            ...
            quarantined_records: self
                ...
                .collect(),
            durable_limits: self.store.durable_limits(&self.version.group),
