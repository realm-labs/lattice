...
use crate::{
    coordinator::{
        ClusterLeaderGuard, LeaderRecord, MemberChange, MemberEvent, MemberHello, MemberRecord,
        MemberRemovalReason, MemberStatus, SessionLimits,
    },
    storage::{
...
///
/// Placement-group leaders consume the exact records produced here; they do
    ...
    S: CoordinatorLeaseStore + ScopedElectionStore + MembershipStore,
{
    pub async fn elect(
        ...
        Ok(Self {
            store,
            guard: ClusterLeaderGuard::new(leader.clone())
