...
async fn candidate_delay(scope: &CoordinatorScope, node: &NodeKey, maximum: Duration) {
...
mod tests {
    ...
    fn candidate_preference_is_deterministic_scoped_and_bounded() {
        let local = node("candidate", 9, 33009);
