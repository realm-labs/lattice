...
> Active implementation plan: [../production-hardening-plan.md](../production-hardening-plan.md).
...
Keep the active execution plan in docs/production-hardening-plan.md.
