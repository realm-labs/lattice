...
- [ ] Preserve the last seen epoch and authority across ownership tombstones and resync/single-event compatibility paths, so a higher store revision cannot reauthorize a lower epoch or a same-epoch different owner/lease after move-away or deletion.
